...
/* if use SWD pins PA13 & PA14 disconnect ST-LINK right after upload */
#define PIN_A            PB12      //ky-040 clk pin, add 100nF/0.1uF capacitors between pin & ground!!!
#define PIN_B            PB15      //ky-040 dt  pin, add 100nF/0.1uF capacitors between pin & ground!!!
#define BUTTON           PB8       //ky-040 sw  pin, add 100nF/0.1uF capacitors between pin & ground!!!
...
void setup()
{
  ...
  while (lcd.begin(LCD_COLUMNS, LCD_ROWS, LCD_5x8DOTS) != true)              //colums - 20, rows - 4, pixels - LCD_5x8DOTS
  {
